...
$id = $_GET['id'];
$data = mysqli_query($db, "SELECT id,kategori FROM kategori_kitab WHERE id='$id'");
                    ...
                    <div class="row">
                      <div class="col-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="kategori" id="kategori" class="form-control" placeholder="ex: Kitab Aqidah" value="<?php echo $data['kategori'] ?>">
                        </div>
                      </div>
                    </div>
