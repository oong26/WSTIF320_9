                    ...
                    <div class="row">
                      <div class="col-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="nama" id="nama" class="form-control" placeholder="ex: Kelas XXX">
                        </div>
                      </div>
                      <div class="col-6">
                        <div class="form-group">
                          <div class="form-group">
                            ...
                            <input type="number" name="jumlah_santri" id="jumlah_santri" class="form-control" placeholder="ex: 100">
                          </div>
                        </div>
                      </div>
                    </div>
