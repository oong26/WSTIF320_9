            ...
            <div class="col-lg-12">
              <div class="card shadow mb-4">
                ...
                <?php
                  ...
                  ?>
                  <form action="insert-kegiatan.php" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="judul">Judul</label><span style="color:red;">*</span>
                      <input type="text" name="judul" id="judul" class="form-control" placeholder="ex: Mengaji bersama">
                    </div>
                    <div class="form-group">
