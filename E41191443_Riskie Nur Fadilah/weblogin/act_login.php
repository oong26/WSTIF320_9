...
switch ($aksi) {
	case 'masuk':
		...
		if (password_verify($password, $data['password'])) {
			$_SESSION['alert']['success'] = "Selamat anda berhasil login";
	...
	case 'daftar':
		...
		if ($sql) {
			$_SESSION['alert']['success'] = "Data berhasil terdaftar";
			header("location:register.php");
		}else{
			$_SESSION['alert']['danger'] = "Gagal daftar, Harap periksa kembali";
			header("location:register.php");
		}
		break;
